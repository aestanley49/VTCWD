...
# theta = 1, n0 = 143000, n.years = 50, rel.risk = 1.0,
...
params <- list(fawn.an.sur = 0.6, juv.an.sur = 0.8, ad.an.f.sur = 0.82,
               ad.an.m.sur = 0.8,
              # fawn.repro = 0.1, juv.repro = 1.3, ad.repro = 1.64, # adjusted from Nick's data
             #  fawn.repro = 0.06, juv.repro = 1.7, ad.repro = 1.8,
             ## problem solving
              fawn.repro = 0.1, juv.repro = 1.7, ad.repro = 1.8,
               hunt.mort.fawn = 0.015, hunt.mort.juv.f = 0.25, hunt.mort.juv.m = 0.25,
               hunt.mort.ad.f = 0.08, hunt.mort.ad.m = 0.75,
               ini.fawn.prev = 0.00,
               ini.juv.prev = 0.00, ini.ad.f.prev = 0.00,  ini.ad.m.prev = 0.00,
               n.age.cats = 12, 
             #n.age.cats.m = 12, n.age.cats.f = 12, 
                p = 0.27, env.foi = 0,  beta.f = 0.08,  beta.m = 0.08,
               theta = 1, n0 = 143000, n.years = 40, rel.risk = 1.0,
               repro.var = 0.005, fawn.sur.var = 0.05, sur.var = 0.005, hunt.var = 0.005,
               #my added var params
               juv.sur.var = 0.005, ad.f.sur.var = 0.05, ad.m.sur.var = 0.05,
               ## juv.repro.var = 0.2, ad.repro.var = 0.1
