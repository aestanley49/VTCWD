...
ComHypowWeights_AVG <- function(selectstrat = "SQ"){
  ...
  simsout1 <- cwd_stoch_wrapper_arrvAVG(params, nsims = 50, n.years = 25, strat = selectstrat, hypothesis = "H1")
  simsout2 <- cwd_stoch_wrapper_arrvAVG(params, nsims = 50, n.years = 25, strat = selectstrat, hypothesis = "H2")
  simsout3 <- cwd_stoch_wrapper_arrvAVG(params, nsims = 50, n.years = 25, strat = selectstrat, hypothesis = "H3")
  simsout4 <- cwd_stoch_wrapper_arrvAVG(params, nsims = 50, n.years = 25, strat = selectstrat, hypothesis = "H4")
