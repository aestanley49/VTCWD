...
```{r, echo=FALSE}
Indiv_county_CheckStations_SRS$MissingAll <- Indiv_county_ALL_SRS$CountyMissingCounties
...
kable(Indiv_county_CheckStations_SRS,
      caption = "Table 7. Estimate of Cost under a Statewide Stratified Random Sampling Design at the County Level",
      align = "lrrrrrr") %>% 
  kable_styling(bootstrap_options = "striped")
```
Similarly to the statewide stratified random sampling, the surveillance design with an alpha of .01 (99% confident), and prevalence of .001 can not be completed with the current number of samples collected at check stations. 
